...
const LoanAgreementScreen = ({ navigation }) => {
  ...
  const steps = [
    { id: 1, title: 'Document Upload', subtitle: 'दस्तावेज़ अपलोड करें', icon: Building2, status: 'done' },
    { id: 2, title: 'Loan Agreement', subtitle: 'ऋण समझौता', icon: Lock, status: 'current' },
    { id: 3, title: 'Agreement OTP Verification', subtitle: 'अनुबंध ओटीपी सत्यापन', icon: Lock, status: 'disabled' },
    { id: 4, title: 'Initiate Disbursal', subtitle: 'संवितरण आरंभ करें', icon: Lock, status: 'disabled' },
  ];
