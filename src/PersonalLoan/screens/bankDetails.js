...
const BankDetailsScreen = ({ navigation }) => {
  ...
  const steps = [
    { id: 1, title: 'Employment Details', subtitle: 'रोजगार विवरण', icon: Building2, status: 'done' },
  { id: 2, title: 'Bank Details', subtitle: 'कृपया अपना बैंक विवरण दर्ज करें', icon: Building2, status: 'current' },
  { id: 3, title: 'Document Upload', subtitle: 'दस्तावेज़ अपलोड करें', icon: Building2, status: 'disabled' },
  { id: 4, title: 'Loan Agreement', subtitle: 'ऋण समझौता', icon: Lock, status: 'disabled' },
  ];
